...
`e2e/tapes/*.tape` via `task record:examples`.
...
rendering, copy the chosen `e2e/tapes/out/<name>.{mp4,gif}`
...
| ---- | ----------- | ----- |
| (none yet) | `e2e/tapes/01-basic-pick.tape` | substring filter + submit |
| (none yet) | `e2e/tapes/09-multiline-submit.tape` | multi-line entry render + submit |
| (none yet) | `e2e/tapes/16-narrow-wrap.tape` | 40-col wrap behaviour |
